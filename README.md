...
![Chọn chế độ nhân bản](screenshots/1_chon_che_do.png)

**Chọn Ổ CŨ / Ổ MỚI (ổ của chính máy trung gian được ẩn để tránh chọn nhầm):**

![Chọn ổ cũ và ổ mới](screenshots/2_chon_o_cu_o_moi.png)

**Hoàn thành — phần mềm hỏi ổ mới sẽ lắp vào máy nào:**

![Hoàn thành nhân bản](screenshots/3_hoan_thanh.png)

**Bảng hướng dẫn chi tiết trượt ra theo lựa chọn (lắp vào máy cũ / laptop mới):**

![Hướng dẫn lắp ổ vào máy mới](screenshots/4_huong_dan_lap_o.png)
...
- **Chỉ hỗ trợ Windows** — không chuyển được Linux, macOS hay hệ điều hành khác (phần mềm tự nhận diện ổ Linux và báo rõ)
